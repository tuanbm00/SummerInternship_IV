...
public:
   ...
   void (ESCALLBACK *keyFunc) ( ESContext *, unsigned char, int, int, bool );
   void (ESCALLBACK *updateFunc) ( ESContext *, float deltaTime );
   void (ESCALLBACK* mouseDownFunc) (ESContext*, int, int, char);
   void (ESCALLBACK* mouseUpFunc) (ESContext*, int, int, char);
   void (ESCALLBACK* mouseMoveFunc) (ESContext*, int, int, char);
