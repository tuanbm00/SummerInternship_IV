...
#define MASK_PLAYER CATEGORY_TERRAIN | CATEGORY_ENEMY | CATEGORY_BULLET_ENEMY | CATEGORY_SLOW_TRAP | CATEGORY_BOSS | CATEGORY_BULLET_BOSS | CATEGORY_GATE
...
#define MASK_GATE CATEGORY_PLAYER
