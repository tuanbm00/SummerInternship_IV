...
void GSAboutUs::Draw() {
	...
	Singleton<TextManager>::GetInstance()->RenderString("Nguyen Van Truong (LEADER)", Vector4(0.0f, 1.0f, 0.0f), Globals::screenWidth / 2 + 10.0f, 500.0f, 1.0f, 1.0f);
	Singleton<TextManager>::GetInstance()->RenderString("Bui Minh Tuan", Vector4(0.0f, 1.0f, 0.0f), Globals::screenWidth / 2 + 10.0f, 450.0f, 1.0f, 1.0f);
	Singleton<TextManager>::GetInstance()->RenderString("Phung Huu Phuoc Toai", Vector4(0.0f, 1.0f, 0.0f), Globals::screenWidth / 2 + 10.0f, 400.0f, 1.0f, 1.0f);
	Singleton<TextManager>::GetInstance()->RenderString("Ngo Quoc Khanh", Vector4(0.0f, 1.0f, 0.0f), Globals::screenWidth / 2 + 10.0f, 350.0f, 1.0f, 1.0f);
}
